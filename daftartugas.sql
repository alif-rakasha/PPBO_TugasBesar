...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2021 at 03:23 PM
...
--
CREATE DATABASE IF NOT EXISTS `daftartugas` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `daftartugas`;
...
CREATE TABLE `matkul` (
  `IDMatkul` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `NamaMatkul` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SKS` int(1) DEFAULT NULL,
  `Deadline` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Kelas` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
INSERT INTO `matkul` (`IDMatkul`, `NamaMatkul`, `SKS`, `Deadline`, `Kelas`) VALUES
('IF1904_TBO', 'Teori Bahasa dan Automata', 3, '4 Juli 2021', 'Teori C'),
('IF1910_STR', 'Strategi Algoritma', 3, '2 Juli 2021', 'Teori C'),
('IF1915_PPBO', 'Praktikum Pemrograman Berorientasi Objek', 1, '1 Juli 2021', 'Praktikum E'),
('IF1907_PBD', 'Praktikum Basis Data', 1, '5 Juli 2021', 'Praktikum F');
...
--
ALTER TABLE `matkul`
  ADD UNIQUE KEY `KodeProduk` (`IDMatkul`);
--
-- Database: `databasetoko`
--
CREATE DATABASE IF NOT EXISTS `databasetoko` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `databasetoko`;
...
('P123_0001', 'SweetTea Minuman Teh Rasa Vanilla Boba', 'Minuman', 'PT. Sugarsweet Tea Industry Indonesia', 'Produk teh kemasan botol yang memiliki perisa Vanilla dengan tambahan Boba di dalamnya.', 7300),
...
('root', '[{\"db\":\"retailuts\",\"table\":\"kategori\"}]');
...
('root', '2021-05-02 13:17:41', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `retailuts`
--
CREATE DATABASE IF NOT EXISTS `retailuts` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `retailuts`;
...
--
-- Table structure for table `produk___transaksi`
--

CREATE TABLE `produk___transaksi` (
...
CREATE TABLE `supplier` (
  ...
  `MEMILIKI_BADAN_HUKUM` tinyint(1) NOT NULL,
  `NAMA_BADAN_HUKUM` varchar(100) DEFAULT NULL,
  `MERUPAKAN_PKP` tinyint(1) NOT NULL,
...
--
-- Table structure for table `supplier___produk`
--

CREATE TABLE `supplier___produk` (
  `ID_PENYUPLAIAN` int(11) NOT NULL,
  `ID_PRODUK` int(11) DEFAULT NULL,
  `ID_SUPPLIER` int(11) DEFAULT NULL,
  `HARGA_POKOK_PRODUK` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `toko` (
  ...
  `KODE_UNIK_TOKO` varchar(20) NOT NULL,
  `NAMA_TOKO` varchar(100) NOT NULL,
  `ALAMAT_LENGKAP` varchar(500) NOT NULL,
  `TIPE_RAK_DISPLAY` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `produk`
  ...
  ADD UNIQUE KEY `PRODUK_PK` (`ID_PRODUK`),
  ADD KEY `PENGELOMPOKKAN_FK` (`ID_KATEGORI`);

--
-- Indexes for table `produk___transaksi`
--
ALTER TABLE `produk___transaksi`
  ADD PRIMARY KEY (`ID_TRANSAKSI_PRODUK`),
  ADD UNIQUE KEY `PRODUK___TRANSAKSI_PK` (`ID_TRANSAKSI_PRODUK`),
  ADD KEY `PENDATAAN_PENJUALAN_FK` (`ID_PRODUK`),
  ADD KEY `PENDATAAN_TRANSAKSI_FK` (`ID_TRANSAKSI`);
...
--
-- Indexes for table `supplier___produk`
--
ALTER TABLE `supplier___produk`
  ADD PRIMARY KEY (`ID_PENYUPLAIAN`),
  ADD UNIQUE KEY `SUPPLIER___PRODUK_PK` (`ID_PENYUPLAIAN`),
  ADD KEY `PENDATAAN_PRODUK_FK` (`ID_PRODUK`),
  ADD KEY `SUPPLIER___PRODUK1_FK` (`ID_SUPPLIER`);
...
ALTER TABLE `toko`
  ...
  ADD UNIQUE KEY `TOKO_PK` (`ID_TOKO`);
...
--
ALTER TABLE `produk`
  ADD CONSTRAINT `FK_PRODUK_PENGELOMP_KATEGORI` FOREIGN KEY (`ID_KATEGORI`) REFERENCES `kategori` (`ID_KATEGORI`);

--
-- Constraints for table `produk___transaksi`
--
ALTER TABLE `produk___transaksi`
  ADD CONSTRAINT `FK_PRODUK___PENDATAAN_PRODUK` FOREIGN KEY (`ID_PRODUK`) REFERENCES `produk` (`ID_PRODUK`),
  ADD CONSTRAINT `FK_PRODUK___PENDATAAN_TRANSAKS` FOREIGN KEY (`ID_TRANSAKSI`) REFERENCES `transaksi` (`ID_TRANSAKSI`);

--
-- Constraints for table `supplier___produk`
--
ALTER TABLE `supplier___produk`
  ADD CONSTRAINT `FK_SUPPLIER_PENDATAAN_PRODUK` FOREIGN KEY (`ID_PRODUK`) REFERENCES `produk` (`ID_PRODUK`),
  ADD CONSTRAINT `FK_SUPPLIER_SUPPLIER__SUPPLIER` FOREIGN KEY (`ID_SUPPLIER`) REFERENCES `supplier` (`ID_SUPPLIER`);

--
-- Constraints for table `transaksi`
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `FK_TRANSAKS_MELAKUKAN_TOKO` FOREIGN KEY (`ID_TOKO`) REFERENCES `toko` (`ID_TOKO`);
--
-- Database: `test`
--
